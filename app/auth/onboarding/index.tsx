...
const onboarding = () => {
  ...
  return (
    <Animated.View style={[styles.container, animatedBackgroundStyle]}>
      {/* Background Shapes */}
      <Animated.View
        style={[styles.shape, styles.shape1, animatedShape1Style]}
      />
      <Animated.View
        style={[styles.shape, styles.shape2, animatedShape2Style]}
      />
            ...
            {currentIndex < slides.length - 1 ? (
              <>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Ionicons name="arrow-forward" size={24} color={whiteColors} />
                </TouchableOpacity>
              </>
            ) : (
